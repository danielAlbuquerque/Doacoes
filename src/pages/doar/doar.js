...
var DoarPage = (function () {
    function DoarPage(navCtrl, navParams) {
        this.navCtrl = navCtrl;
        this.navParams = navParams;
    }
    DoarPage.prototype.ionViewDidLoad = function () {
        console.log('ionViewDidLoad DoarPage');
    };
    /**
     * Redireciona o usuário para a página de add
     */
    DoarPage.prototype.add = function () {
