...
*/
var ConversasPage = (function () {
    function ConversasPage(navCtrl, navParams) {
        this.navCtrl = navCtrl;
        this.navParams = navParams;
    }
    ConversasPage.prototype.ionViewDidLoad = function () {
        console.log('ionViewDidLoad ConversasPage');
    };
    return ConversasPage;
}());
ConversasPage = __decorate([
    Component({
